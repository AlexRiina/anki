...
from anki import sqlalchemy_fields
...
class Card(Base):
    ...
    type = Column(sqlalchemy_fields.IntEnum[CardType](CardType), nullable=False, default=CardType.new)
    queue = Column(sqlalchemy_fields.IntEnum[QueueType](QueueType), nullable=False, default=QueueType.new)
    ...
    flags = Column(sqlalchemy_fields.IntEnum[FlagColor](FlagColor), nullable=False, default=0)
...
class Grave(Base):
    ...
    type = Column(sqlalchemy_fields.IntEnum[GraveType](GraveType), nullable=False, primary_key=True)
